<template>
	<svg
		...
		<path
			...
			stroke-width="8" />
		<path
			d="m42.1,24.95c.62-.75,1.5-1.63,2.68-2.42,1.13-.75,2.2-1.18,3.07-1.45"
			fill="none"
			opacity=".65"
			stroke="#fff"
			stroke-linecap="round"
...
<style lang="scss" scoped>
	.pokeball-icon {
		animation: shake 2.5s ease-in-out infinite forwards;
	}

	#Button {
		animation: capturing 3s ease-in-out infinite forwards;
	}
